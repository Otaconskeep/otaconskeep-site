...
Stand up Prowlarr↔Sonarr/Radarr tests, write a household quality sentence, score five controlled candidates, then sync profiles through one authoritative automation path with dry-run and rollback evidence.

## Evidence required

Service-contract table; candidate score sheet; dry-run output; rollback proof; legal boundary acknowledged.
