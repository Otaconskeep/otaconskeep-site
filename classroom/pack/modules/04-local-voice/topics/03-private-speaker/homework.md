# Homework: Private smart speaker
...
2. Produce the **build output** for this topic: wake-to-action-to-spoken-response system that passes with internet disconnected
