...
Apply (workflow build) → Evaluate (approval boundaries & blast radius)
...
| ID | Topic | Activities |
|---|---|---|
| 05.01 | n8n homelab automation | [Lesson](topics/01-n8n-automation/lesson.md) · [Reading](topics/01-n8n-automation/reading.md) · [Lab](topics/01-n8n-automation/lab.md) · [Homework](topics/01-n8n-automation/homework.md) · [Quiz](topics/01-n8n-automation/quiz.md) |
...
Depends on Module 1 networking/ops and Module 3 security boundaries; capstone reuses guarded automation evidence.
