...
# Voice Measurement Sheet

| Trial | Distance/noise | Wake detected | Transcript | Correct intent | Action pass | TTS pass | Total latency | Failure layer |
|---:|---|---|---|---|---|---|---:|---|
| 1 | | | | | | | | |
| 2 | | | | | | | | |
| 3 | | | | | | | | |
...
# ARR Candidate Evaluation Sheet

| Candidate | Parsed quality | CF matches | Total score | Rejections | Existing file comparison | Expected result | Actual result |
|---|---|---|---:|---|---|---|---|
| A | | | | | | | |
| B | | | | | | | |
| C | | | | | | | |
